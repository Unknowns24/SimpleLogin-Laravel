...
<html lang="en">
    <head>
        ...
        <title><?php echo env('APP_NAME') ?> - Cambiar contraseña</title>
        <!-- Icon -->
            ...
            <div class="row d-flex justify-content-center mx-auto" style="margin-top:15%">
                <div class="col-8 col-lg-6">
                    <div class="card">
                        ...
                        @if(isset($userToken) && isset($id) && $userToken != NULL)
                            <div class="card-body text-center p-4">
                                <form id="register" class="form-signin" method="POST" action="{{ route('reset.password', $id) }}">
                                    @csrf
                                    ...
                                    <div class="input-group mx-auto mt-2" style="max-width: 300px;">
                                        <button class="btn btn-lg btn-primary btn-block" id="submit-btn">Confirmar</button>
                                    </div>
                        ...
                        @else
                            <div class="card-body text-center p-4">
                                <p>¡Tu link de acceso no es valido o ya ha expirado!<p>
